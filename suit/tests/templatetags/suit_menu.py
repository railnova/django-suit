...
class SuitMenuTestCase(ModelsTestCaseMixin, UserTestCaseMixin):
        ...
        settings.SUIT_CONFIG.update(
            {
                ...
                "MENU": [
                    ...
                    {"label": "C5", "url": "/c/5", "models": ("%s.book" % app_label,)},
                    {
                        "label": "C6",
                        "url": "admin:index",
                        "models": ({"label": "mx", "url": "admin:index"},),
                    },
                    ...
                    {
                        "app": app_label,
                        "models": ["%s.book" % app_label, "%s.album" % app_label],
                    },
                    {
                        "app": app_label,
                        "models": [
        ...
        settings.SUIT_CONFIG.update(
            {
                ...
                "MENU_ORDER": (
                    ...
                    (
                        (
                            "Custom app no models tuple perms",
                            "/custom-app-tuple-perms",
                            "",
                            ("mega-rights",),
                        ),
                    ),
    ...
    def test_menu_custom_app_permissions(self):
        settings.SUIT_CONFIG["MENU"] = (
            {"label": "a", "permissions": "secure-perms"},
